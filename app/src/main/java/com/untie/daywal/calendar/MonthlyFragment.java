...
public class MonthlyFragment extends Fragment {
    ...
    public interface OnMonthChangeListener {
        ...
        void onDayLongClick(OneDayView dayView);
    }
     ...
     */
    public VerticalViewPager vvPager;

    public MonthlySlidePagerAdapter adapter;
    private int mYear = -1;
    ...
    private OneMonthView.OnLongClickDayListener onLongClickDayListener = new OneMonthView.OnLongClickDayListener() {

        @Override
        public void onLongClick(OneDayView odv) {
            listener.onDayLongClick(odv);
        }
    };
    ...
    class MonthlySlidePagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            monthViews[position].setOnLongClickDayListener(onLongClickDayListener);
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            ...
            ((OneMonthView) object).setOnLongClickListener(null);
